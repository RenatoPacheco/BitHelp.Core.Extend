...
namespace BitHelp.Core.Extend.Test.ExpressionExtendTest
{
    public class PropertyDisplayTest
    {
        ...
        public void Check_property_disply()
        {
            ...
            Assert.Equal(nameof(singles.Char), this.PropertyDisplay<SingleValues>(x => x.Char));
            Assert.Equal(nameof(singles.String), this.PropertyDisplay<SingleValues>(x => x.String));
            Assert.Equal(nameof(singles.Int), this.PropertyDisplay<SingleValues>(x => x.Int));
            Assert.Equal("Int null", this.PropertyDisplay<SingleValues>(x => x.IntNull));
            Assert.Equal(nameof(singles.Long), this.PropertyDisplay<SingleValues>(x => x.Long));
            Assert.Equal("Long null", this.PropertyDisplay<SingleValues>(x => x.LongNull));
            Assert.Equal(nameof(singles.Decimal), this.PropertyDisplay<SingleValues>(x => x.Decimal));
            Assert.Equal("Decimal null", this.PropertyDisplay<SingleValues>(x => x.DecimalNull));
            Assert.Equal(nameof(singles.Uint), this.PropertyDisplay<SingleValues>(x => x.Uint));
            ...
            Assert.Equal(nameof(singles.Guid), this.PropertyDisplay<SingleValues>(x => x.Guid));
            Assert.Equal("Guid null", this.PropertyDisplay<SingleValues>(x => x.GuidNull));
            Assert.Equal(nameof(singles.Bool), this.PropertyDisplay<SingleValues>(x => x.Bool));
